...
RawData<-as.matrix(read.csv("genexp_sample probe profile.csv", header=T, row.names=1))
...
GeneIdentifiers<-RawData[,c(1, c(127:146))]
...
which("4590"==colnames(NormFiltered))
...
legend(min(PC2noOutliers), max(PC1noOutliers)-10, c("Control", "MDD"), text.col=c(3, 2), pch=19, col=c(3, 2))
dev.off()
...
legend(min(PC4noOutliers), max(PC3noOutliers)-10, c("Control", "MDD"), text.col=c(3, 2), pch=19, col=c(3, 2))
dev.off()
...
sinTODNoOutliers<-sin((2*pi*TODNoOutliers)/24) 
cosTODNoOutliers<-cos((2*pi*TODNoOutliers)/24) 
...
SubjectContinuousVariables<-cbind(AgeNoOutliers, RNAAgeNoOutliers, BrainpHNoOutliers, RNAconcNoOutliers, RNAintegrityNoOutliers, sinTODNoOutliers, cosTODNoOutliers, HoursColdNoOutliers, HoursIceNoOutliers, HoursFinalNoOutliers, HoursColdIceNoOutliers, HoursFinalCorrectedNoOutliers)
...
summary.lm(lm(RNAconcNoOutliers~AgeNoOutliers+BrainpHNoOutliers+DiagnosisNoOutliers+GenderNoOutliers+RNAintegrityNoOutliers+RNAAgeNoOutliers+sinTODNoOutliers+cosTODNoOutliers+HoursColdNoOutliers+HoursIceNoOutliers+HoursFinalNoOutliers+HoursFinalCorrectedNoOutliers))
...
summary.lm(lm(RNAintegrityNoOutliers~AgeNoOutliers+BrainpHNoOutliers+DiagnosisNoOutliers+GenderNoOutliers+RNAconcNoOutliers+RNAAgeNoOutliers+sinTODNoOutliers+cosTODNoOutliers+HoursColdNoOutliers+HoursIceNoOutliers+HoursFinalNoOutliers+HoursFinalCorrectedNoOutliers))
...
capture.output(
#Calculating the variance inflation factor (vif) to determine which subject variables are highly related to other subject variables in the data set. Most important, of course, is whether any of the subject variables strongly correlate with Diagnosis. Note that "Location on Chip" has been removed as a variable because it is partially redundant with gender. 
summary.lm(lm(PC1noOutliers~))
),

capture.output(
summary.lm(lm(PC2noOutliers~))
),

capture.output(
summary.lm(lm(PC3noOutliers~))
),

capture.output(
summary.lm(lm(PC4noOutliers~))
),
...
###For example, in the B amygdala, these variables are related to diagnosis:
####A. HoursFinalNoOutliers
####B. SuicidenoOutliers (duh!)
####C. HoursFinalNoOutliers
####D. RNAconcNoOutliers (correlates with suicide, borderline correlation with diagnosis)

###And these variables are related to the PCs:
####A. DiagnosisNoOutliers (PC1, PC2)
####B. SuicideNoOutliers (PC1)
####C. LocationOnChipNoOutliers (PC2)
####D. GenderNoOutliers (PC2, PC3)
####E. TODNoOutliers (PC3)
...
##I'm probably going to skip LocationOnChip for right now, since it is a mutifactor variables and not quite as sig. related to the PCs as other variables
##I'm also going to skip TOD due to nonlinearity.

##2. Insert those variables into this code, placing diagnosis as the first variable.

##The first model I ran was just standard (even though Age and Gender don't seem very important for the AB)
...
AmpEfficiencyNoOutliers<-AmpEfficiency[OutlierRemovalIndices]
...
png("MDD Betas from Model with and without AmpEfficiency.png")
plot(LM7Betas[,2]~LM2Betas[,2], main="MDD Betas are similar whether we use a Model with or without AmpEfficiency")
abline(a=0, b=1, col=2)
dev.off()
...
LinearModel3<-function(i){lm(normNoOutliers[i,]~DiagnosisNoOutliers+AgeNoOutliers+RNAintegrityNoOutliers+BrainpHNoOutliers+GenderNoOutliers+HoursFinalCorrectedNoOutliers+sinTODNoOutliers+cosTODNoOutliers)}
...
#Outputting the p-values, betas, and gene identifiers:
LM3testOutputMDD<-cbind(row.names(normNoOutliers), LM3PvalAdj, LM3Betas[,2], GeneIdentifiers_filtered)
row.names(LM3testOutputMDD)<-row.names(normNoOutliers)
colnames(LM3testOutputMDD)[c(1:5)]<-c("X", "Unadjusted P-value", "BH Adjusted Pvalue", "BY Adjusted Pvalue", "Beta")

LM3testOutputMDDv2<- join(as.data.frame(LM3testOutputMDD), ProbeInfoOutput, by = "X")
write.csv(LM3testOutputMDDv2, "LM3testOutputMDDv2.csv")


#Output for Age:

#Applying two different types of multiple-comparison corrections to the raw p-values (Benjamini-Hochberg and Benjamini-Yekutieli):
TempPvalAdjLM3<-mt.rawp2adjp(LM3pvalues[,3], proc=c("BH", "BY"))
LM3PvalAdj<-TempPvalAdjLM3$adjp[order(TempPvalAdjLM3$index),]
row.names(LM3PvalAdj)<-row.names(normNoOutliers)

#Outputting the p-values, betas, and gene identifiers:
LM3testOutputAge<-cbind(row.names(normNoOutliers), LM3PvalAdj, LM3Betas[,3], GeneIdentifiers_filtered)
row.names(LM3testOutputAge)<-row.names(normNoOutliers)
colnames(LM3testOutputAge)[c(1:5)]<-c("X", "Unadjusted P-value", "BH Adjusted Pvalue", "BY Adjusted Pvalue", "Beta")

LM3testOutputAgev2<- join(as.data.frame(LM3testOutputAge), ProbeInfoOutput, by = "X")
write.csv(LM3testOutputAgev2, "LM3testOutputAgev2.csv")


#Output for RNA Integrity:

#Applying two different types of multiple-comparison corrections to the raw p-values (Benjamini-Hochberg and Benjamini-Yekutieli):
TempPvalAdjLM3<-mt.rawp2adjp(LM3pvalues[,4], proc=c("BH", "BY"))
LM3PvalAdj<-TempPvalAdjLM3$adjp[order(TempPvalAdjLM3$index),]
row.names(LM3PvalAdj)<-row.names(normNoOutliers)

#Outputting the p-values, betas, and gene identifiers:
LM3testOutputRNAIntegrity<-cbind(row.names(normNoOutliers), LM3PvalAdj, LM3Betas[,4], GeneIdentifiers_filtered)
row.names(LM3testOutputRNAIntegrity)<-row.names(normNoOutliers)
colnames(LM3testOutputRNAIntegrity)[c(1:5)]<-c("X", "Unadjusted P-value", "BH Adjusted Pvalue", "BY Adjusted Pvalue", "Beta")

LM3testOutputRNAIntegrityv2<- join(as.data.frame(LM3testOutputRNAIntegrity), ProbeInfoOutput, by = "X")
write.csv(LM3testOutputRNAIntegrityv2, "LM3testOutputRNAIntegrityv2.csv")


#Output for BrainPH:

#Applying two different types of multiple-comparison corrections to the raw p-values (Benjamini-Hochberg and Benjamini-Yekutieli):
TempPvalAdjLM3<-mt.rawp2adjp(LM3pvalues[,5], proc=c("BH", "BY"))
LM3PvalAdj<-TempPvalAdjLM3$adjp[order(TempPvalAdjLM3$index),]
row.names(LM3PvalAdj)<-row.names(normNoOutliers)

#Outputting the p-values, betas, and gene identifiers:
LM3testOutputBrainPH<-cbind(row.names(normNoOutliers), LM3PvalAdj, LM3Betas[,5], GeneIdentifiers_filtered)
row.names(LM3testOutputBrainPH)<-row.names(normNoOutliers)
colnames(LM3testOutputBrainPH)[c(1:5)]<-c("X", "Unadjusted P-value", "BH Adjusted Pvalue", "BY Adjusted Pvalue", "Beta")

LM3testOutputBrainPHv2<- join(as.data.frame(LM3testOutputBrainPH), ProbeInfoOutput, by = "X")
write.csv(LM3testOutputBrainPHv2, "LM3testOutputBrainPHv2.csv")


#Output for Gender:

#Applying two different types of multiple-comparison corrections to the raw p-values (Benjamini-Hochberg and Benjamini-Yekutieli):
TempPvalAdjLM3<-mt.rawp2adjp(LM3pvalues[,6], proc=c("BH", "BY"))
LM3PvalAdj<-TempPvalAdjLM3$adjp[order(TempPvalAdjLM3$index),]
row.names(LM3PvalAdj)<-row.names(normNoOutliers)

#Outputting the p-values, betas, and gene identifiers:
LM3testOutputGender<-cbind(row.names(normNoOutliers), LM3PvalAdj, LM3Betas[,6], GeneIdentifiers_filtered)
row.names(LM3testOutputGender)<-row.names(normNoOutliers)
colnames(LM3testOutputGender)[c(1:5)]<-c("X", "Unadjusted P-value", "BH Adjusted Pvalue", "BY Adjusted Pvalue", "Beta")

LM3testOutputGenderv2<- join(as.data.frame(LM3testOutputGender), ProbeInfoOutput, by = "X")
write.csv(LM3testOutputGenderv2, "LM3testOutputGenderv2.csv")
...
#Applying two different types of multiple-comparison corrections to the raw p-values (Benjamini-Hochberg and Benjamini-Yekutieli):
TempPvalAdjLM3<-mt.rawp2adjp(LM3pvalues[,7], proc=c("BH", "BY"))
LM3PvalAdj<-TempPvalAdjLM3$adjp[order(TempPvalAdjLM3$index),]
row.names(LM3PvalAdj)<-row.names(normNoOutliers)

#Outputting the p-values, betas, and gene identifiers:
LM3testOutputHoursFinal<-cbind(row.names(normNoOutliers), LM3PvalAdj, LM3Betas[,7], GeneIdentifiers_filtered)
row.names(LM3testOutputHoursFinal)<-row.names(normNoOutliers)
colnames(LM3testOutputHoursFinal)[c(1:5)]<-c("X", "Unadjusted P-value", "BH Adjusted Pvalue", "BY Adjusted Pvalue", "Beta")

LM3testOutputHoursFinalv2<- join(as.data.frame(LM3testOutputHoursFinal), ProbeInfoOutput, by = "X")
write.csv(LM3testOutputHoursFinalv2, "LM3testOutputHoursFinalv2.csv")
...
##Based on variables that correlate with diagnosis or the PCs


##2. Insert those variables into this code, placing diagnosis as the first variable.

LinearModel2<-function(i){lm(normNoOutliers[i,]~DiagnosisNoOutliers+HoursFinalNoOutliers+RNAconcNoOutliers+GenderNoOutliers+LocationOnChipNoOutliers)}
...
******17v3: removing cohort and location on chip**************

#I'm going to try running LM2 again, but without location on chip since it takes up so much df:


LinearModel3<-function(i){lm(normNoOutliers[i,]~DiagnosisNoOutliers+HoursFinalNoOutliers+RNAconcNoOutliers+GenderNoOutliers)}
...
******17v4: one more time, including suicide as a variable**************

#I'm going to try running LM2 again, but without cohort and location on chip since they take up so much df and don't seem to really matter:

LinearModel4<-function(i){lm(normNoOutliers[i,]~DiagnosisNoOutliers+HoursFinalNoOutliers+RNAconcNoOutliers+GenderNoOutliers+SuicideNoOutliers)}


##3. Then run this code (Ctrl+R) to get the p-values:


#***CODE TO RUN FOR STEP 17v4****
...
#Outputting a histogram illustrating the raw p-values in comparison to what would be expected by chance:
for (i in 1:NumberofXsLM4){
png(paste(paste("17 Histogram of Unadjusted Pvalues Using LM4 for", NameofXsLM4[i], sep="  "), "png", sep="."))	
hist(LM4pvalues[,i], breaks=100, col=i, main=paste("Unadjusted P-values using LM4 for", NameofXsLM4[i], sep="  "), xlab="Unadjusted p-value", ylab="Count")
abline(a=(length(normNoOutliers[,1])/100), b=0)
dev.off()		
}		

#Outputting the raw pvalues and LM related statistics:
LM4BetasOutput<-cbind(LM4Betas, GeneIdentifiers_filtered) 
LM4SEOutput<-cbind(LM4Betas, GeneIdentifiers_filtered)
LM4TstatOutput<-cbind(LM4Tstat, GeneIdentifiers_filtered)
LM4pvaluesOutput<-cbind(LM4pvalues, GeneIdentifiers_filtered)

write.csv(LM4BetasOutput, "LM4Betas.csv")
write.csv(LM4SEOutput, "LM4SE.csv")
write.csv(LM4TstatOutput, "LM4Tstat.csv")
write.csv(LM4pvaluesOutput, "LM4pvaluesRAW.csv")


#Applying two different types of multiple-comparison corrections to the raw p-values (Benjamini-Hochberg and Benjamini-Yekutieli):
TempPvalAdjLM4<-mt.rawp2adjp(LM4pvalues[,2], proc=c("BH", "BY"))
LM4PvalAdj<-TempPvalAdjLM4$adjp[order(TempPvalAdjLM4$index),]
row.names(LM4PvalAdj)<-row.names(normNoOutliers)

#Outputting the p-values, betas, and gene identifiers:
LM4testOutput<-cbind(LM4PvalAdj, LM4Betas[,2], GeneIdentifiers_filtered)
row.names(LM4testOutput)<-row.names(normNoOutliers)
colnames(LM4testOutput)<-c("Unadjusted P-value", "BH Adjusted Pvalue", "BY Adjusted Pvalue", "Beta", "SYMBOL", "X9231092151_F.BEAD_STDERR", "SEARCH_KEY", "ILMN_GENE", "CHROMOSOME", "DEFINITION", "SYNONYMS", "TargetID", "ProbeID", "SOURCE_REFERENCE_ID", "REFSEQ_ID", "UNIGENE_ID", "ENTREZ_GENE_ID", "PROBE_TYPE", "PROBE_START", "PROBE_SEQUENCE", "PROBE_COORDINATES", "ONTOLOGY_COMPONENT", "ONTOLOGY_PROCESS", "ONTOLOGY_FUNCTION", "OBSOLETE PROBE ID")


write.csv(LM4testOutput, "LM4testOutput.csv")
#***END OF CODE FOR STEP 17v4****


#Comparison of results MDD vs. Suicide:

png("19 Model Comparison LM4 MDD vs. Suicide.png")
plot(log(LM4pvalues[,2])~log(LM4pvalues[,5]), main="Model Comparison: LM4- MDD vs. Suicide", xlab="Suicide", ylab="MDD")
dev.off()

png("19 Model Comparison LM4 HoursFinal vs. Suicide.png")
plot(log(LM4pvalues[,3])~log(LM4pvalues[,5]), main="Model Comparison: LM4- HoursFinal vs. Suicide", xlab="Suicide", ylab="HoursFinal")
dev.off()

##skipped, since BrainPH wasn't used in the analysis:
png("19 Model Comparison LM4 BrainPH vs. Suicide.png")
plot(log(LM4pvalues[,6])~log(LM4pvalues[,7]), main="Model Comparison: LM4- BrainPH vs. Suicide", xlab="Suicide", ylab="BrainPH")
dev.off()
...
#Outputting the p-values, betas, and gene identifiers:
LM4testOutput<-cbind(LM4PvalAdj, LM4Betas[,2], NormNoOutliersMedianCTRL, Detection_PvalueMedianCTRL, NormNoOutliersMedianMDD, Detection_PvalueMedianMDD,GeneIdentifiers_filtered)
row.names(LM4testOutput)<-row.names(normNoOutliers)
colnames(LM4testOutput)<-c("Unadjusted P-value", "BH Adjusted Pvalue", "BY Adjusted Pvalue", "Beta", "NormNoOutliersMedianCTRL", "Detection_PvalueMedianCTRL", "NormNoOutliersMedianMDD", "Detection_PvalueMedianMDD", "SYMBOL", "X9231092151_F.BEAD_STDERR", "SEARCH_KEY", "ILMN_GENE", "CHROMOSOME", "DEFINITION", "SYNONYMS", "TargetID", "ProbeID", "SOURCE_REFERENCE_ID", "REFSEQ_ID", "UNIGENE_ID", "ENTREZ_GENE_ID", "PROBE_TYPE", "PROBE_START", "PROBE_SEQUENCE", "PROBE_COORDINATES", "ONTOLOGY_COMPONENT", "ONTOLOGY_PROCESS", "ONTOLOGY_FUNCTION", "OBSOLETE PROBE ID")
...
setwd("~/Documents/AMY LCM 10nuclei/Basal/13 BrainInABlender")
...
SirUnMixALotOutput<-Sir_UnMixALot(userInput=temp, dataColumns=c(2:41), geneColumn=1, species="human")
...
plot(AveragePrimary_CellTypeIndex[8,]~AveragePrimary_CellTypeIndex[9,], xlab="Oligodendrocyte_Immature Index", ylab="Oligodendrocyte Index", lwd=1.5, cex.lab=1.3, col=as.numeric(DiagnosisNoOutliers)*-1+4)
mtext("Basal", line=1, cex=1.5)
#legend(min(PC1noOutliers), max(PC2noOutliers)+10, c("Control", "MDD"), text.col=c(3, 2), pch=19, col=c(3, 2))
dev.off()
...
pdf("Oligodendrocyte_ByDiagnosis.pdf", height=4.5, width=4)
boxplot(AveragePrimary_CellTypeIndex[8,]~DiagnosisNoOutliers, xlab="Diagnosis", ylab="Oligodendrocyte Index", lwd=1.5, cex.lab=1.3)
stripchart(AveragePrimary_CellTypeIndex[8,]~DiagnosisNoOutliers, vertical = TRUE, 
           method = "jitter", add = TRUE, pch = 20, cex=1.5, col = c(3,2))
mtext("Basal", line=1, cex=1.5)
dev.off()

pdf("ImmatureOligodendrocyte_ByDiagnosis.pdf", height=4.5, width=4)
boxplot(AveragePrimary_CellTypeIndex[9,]~DiagnosisNoOutliers, xlab="Diagnosis", ylab="Immature Oligodendrocyte Index", lwd=1.5, cex.lab=1.3)
stripchart(AveragePrimary_CellTypeIndex[9,]~DiagnosisNoOutliers, vertical = TRUE, 
           method = "jitter", add = TRUE, pch = 20, cex=1.5, col = c(3,2))
mtext("Basal", line=1, cex=1.5)
dev.off()
...
with(res, plot(log2FoldChange, -log10(pvalue), pch=20, main="Volcano plot: Basal", xlim=c(-3,3), cex.lab=1.3, cex=0.6))
...
hist(LM2SE[,2], breaks=100, col=2, xlab="SE", main="Basal", cex.lab=1.3)
dev.off()
