...
##Example:
which("4939"==colnames(NormFiltered))
...
LinearModel3<-function(i){lm(normNoOutliers[i,]~DiagnosisNoOutliers+BrainpHNoOutliers+GenderNoOutliers+HoursFinalNoOutliers+RNAconcNoOutliers)}
...
with(res, plot(log2FoldChange, -log10(pvalue), pch=20, main="Volcano plot: AAA", xlim=c(-3,3), cex.lab=1.3, cex=0.6))
...
hist(LM2SE[,2], breaks=100, col=2, xlab="SE", main="AAA", cex.lab=1.3)
dev.off()
...
setwd("~/Documents/AMY LCM 10nuclei/AAA/13 BrainInABlender")
