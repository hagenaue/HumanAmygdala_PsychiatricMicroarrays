...
RawData<-as.matrix(read.csv("Sample Probe Profile_AHA_genexp_rescan_againgenomestudio.csv", header=T, row.names=1))
...
##Example:
which("4905"==colnames(NormFiltered))
which("4968"==colnames(NormFiltered))
...
###For example, in the AHA amygdala, these variables are related to diagnosis:
####A. HoursFinalNoOutliers
####B. SuicidenoOutliers (duh!)

###And these variables are related to the PCs:
####A. BrainpHNoOutliers (PC1, PC4)
####B. DiagnosisNoOutliers (PC1, PC2)
####C. RNAintegrityNoOutliers (PC2)
####D. SuicideNoOutliers (PC2, PC4-borderline sig)
####E. CohortNoOutliers (PC2)
####F. LocationOnChipNoOutliers (PC3)
####G. RNAconcNoOutliers (PC3)
####G. OverdoseNoOutliers (PC4)
...
LinearModel2<-function(i){lm(normNoOutliers[i,]~DiagnosisNoOutliers+HoursFinalNoOutliers+RNAintegrityNoOutliers+RNAconcNoOutliers+BrainpHNoOutliers+CohortNoOutliers+LocationOnChipNoOutliers)}
...
LinearModel3<-function(i){lm(normNoOutliers[i,]~DiagnosisNoOutliers+HoursFinalNoOutliers+RNAintegrityNoOutliers+RNAconcNoOutliers+BrainpHNoOutliers)}
...
LinearModel4<-function(i){lm(normNoOutliers[i,]~DiagnosisNoOutliers+HoursFinalNoOutliers+RNAintegrityNoOutliers+RNAconcNoOutliers+BrainpHNoOutliers+SuicideNoOutliers)}
...
plot(log(LM4pvalues[,2])~log(LM4pvalues[,7]), main="Model Comparison: LM4- MDD vs. Suicide", xlab="Suicide", ylab="MDD")
dev.off()

png("19 Model Comparison LM4 HoursFinal vs. Suicide.png")
plot(log(LM4pvalues[,3])~log(LM4pvalues[,7]), main="Model Comparison: LM4- HoursFinal vs. Suicide", xlab="Suicide", ylab="HoursFinal")
dev.off()
...
setwd("~/Documents/AMY LCM 10nuclei/AHA/13 BrainInABlender")
...
pdf("RBCvsEndothelial_ByDiagnosis.pdf", height=4.5, width=4)
plot(AveragePrimary_CellTypeIndex[2,]~AveragePrimary_CellTypeIndex[10,], xlab="RBC Index", ylab="Endothelial Index", lwd=1.5, cex.lab=1.3, col=as.numeric(DiagnosisNoOutliers)*-1+4)
mtext("AHA", line=1, cex=1.5)
#legend(min(PC1noOutliers), max(PC2noOutliers)+10, c("Control", "MDD"), text.col=c(3, 2), pch=19, col=c(3, 2))
dev.off()


pdf("RBC_ByDiagnosis.pdf", height=4.5, width=4)
boxplot(AveragePrimary_CellTypeIndex[10,]~DiagnosisNoOutliers, xlab="Diagnosis", ylab="RBC Index", lwd=1.5, cex.lab=1.3)
stripchart(AveragePrimary_CellTypeIndex[10,]~DiagnosisNoOutliers, vertical = TRUE, 
...
pdf("Interneuron_ByDiagnosis.pdf", height=4.5, width=4)
boxplot(AveragePrimary_CellTypeIndex[6,]~DiagnosisNoOutliers, xlab="Diagnosis", ylab="Interneuron Index", lwd=1.5, cex.lab=1.3)
stripchart(AveragePrimary_CellTypeIndex[6,]~DiagnosisNoOutliers, vertical = TRUE, 
           method = "jitter", add = TRUE, pch = 20, cex=1.5, col = c(3,2))
mtext("AHA", line=1, cex=1.5)
#legend(min(PC1noOutliers), max(PC2noOutliers)+10, c("Control", "MDD"), text.col=c(3, 2), pch=19, col=c(3, 2))
dev.off()

pdf("ProjectionNeuron_ByDiagnosis.pdf", height=4.5, width=4)
boxplot(AveragePrimary_CellTypeIndex[7,]~DiagnosisNoOutliers, xlab="Diagnosis", ylab="Projection Neuron Index", lwd=1.5, cex.lab=1.3)
stripchart(AveragePrimary_CellTypeIndex[7,]~DiagnosisNoOutliers, vertical = TRUE, 
           method = "jitter", add = TRUE, pch = 20, cex=1.5, col = c(3,2))
mtext("AHA", line=1, cex=1.5)
#legend(min(PC1noOutliers), max(PC2noOutliers)+10, c("Control", "MDD"), text.col=c(3, 2), pch=19, col=c(3, 2))
dev.off()
...
with(res, plot(log2FoldChange, -log10(pvalue), pch=20, main="Volcano plot: AHA", xlim=c(-3,3), cex.lab=1.3, cex=0.6))
...
hist(LM2SE[,2], breaks=100, col=2, xlab="SE", main="AHA", cex.lab=1.3)
dev.off()
